...
Clone the git repository, and you can run the entire ActiveRecord test suite with read_from_slave installed by typing rake test.

<pre>
<code>
$ rake test
...
Finished in 43.358152 seconds.

2029 tests, 6620 assertions, 0 failures, 0 errors
</code>
</pre>
...
* Write specific tests for slave dbs
